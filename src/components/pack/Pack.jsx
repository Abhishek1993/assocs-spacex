          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-3">
              <button
                ...
                className="text-center bg-green-100 focus:outline-none active:bg-green-100 hover:bg-green-900 font-bold mx-4 md:mx-1 lg:mx-4 px-1 py-1 rounded"
              >
                2006
              </button>
              <button
                ...
                className="bg-green-100 focus:outline-none active:bg-green-100 hover:bg-green-900 font-bold mx-4 md:mx-1 lg:mx-4 px-1 py-1 rounded"
              >
                2007
              </button>
              <button
